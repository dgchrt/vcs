...
unsigned char data_indirect_x() { return bus_read(addr_indirect_x()); }

unsigned char data_indirect_y() { return bus_read(addr_indirect_y()); }
...
unsigned char flag_break() { return processor_status_flag(STATUS_BIT_BREAK); }

void flag_break_set() { processor_status_flag_set(STATUS_BIT_BREAK); }

void flag_break_unset() { processor_status_flag_unset(STATUS_BIT_BREAK); }

unsigned char flag_carry() { return processor_status_flag(STATUS_BIT_CARRY); }

void flag_carry_set() { processor_status_flag_set(STATUS_BIT_CARRY); }

void flag_carry_unset() { processor_status_flag_unset(STATUS_BIT_CARRY); }

unsigned char flag_decimal() {
  return processor_status_flag(STATUS_BIT_DECIMAL);
}

void flag_decimal_set() { processor_status_flag_set(STATUS_BIT_DECIMAL); }

void flag_decimal_unset() { processor_status_flag_unset(STATUS_BIT_DECIMAL); }

unsigned char flag_interrupt() {
  return processor_status_flag(STATUS_BIT_INTERRUPT);
}

void flag_interrupt_set() { processor_status_flag_set(STATUS_BIT_INTERRUPT); }
...
void flag_negative_set() { processor_status_flag_set(STATUS_BIT_NEGATIVE); }

void flag_negative_unset() { processor_status_flag_unset(STATUS_BIT_NEGATIVE); }

unsigned char flag_overflow() {
  return processor_status_flag(STATUS_BIT_OVERFLOW);
}

void flag_overflow_set() { processor_status_flag_set(STATUS_BIT_OVERFLOW); }

void flag_overflow_unset() { processor_status_flag_unset(STATUS_BIT_OVERFLOW); }

unsigned char flag_zero() { return processor_status_flag(STATUS_BIT_ZERO); }

void flag_zero_set() { processor_status_flag_set(STATUS_BIT_ZERO); }

void flag_zero_unset() { processor_status_flag_unset(STATUS_BIT_ZERO); }
...
unsigned short stack_pull() { return stack[++stack_pointer]; }

void stack_push(unsigned short data) { stack[stack_pointer--] = data; }
